    ...
    return (
        <div className='box'>
            <div className={styles['why-us']}>
                What Benefits Do You Get as a Tesla Owner?
            </div>
            ...
            <div className={styles['features-container']}>
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/tesla/tesla-why-1.webp'
                ...
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/tesla/tesla-why-2.webp'
                ...
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/tesla/tesla-why-3.webp'
