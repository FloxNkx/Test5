            ...
            <div className={styles['features-container']}>
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/detailing/checkbox-1.webp'
                ...
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/detailing/checkbox-2.webp'
                ...
                <div className={styles['feature-box']}>
                    <div className={styles['icon-container']}>
                        <img
                            src='https://carrectly.s3.amazonaws.com/public/detailing/checkbox-3.webp'
